...
## Project Context
This project uses ai-devkit for structured AI-assisted development. Phase documentation is located in `docs/`.

## Documentation Structure
- `docs/requirements/` - Problem understanding and requirements
- `docs/design/` - System architecture and design decisions (include mermaid diagrams)
- `docs/planning/` - Task breakdown and project planning
- `docs/implementation/` - Implementation guides and notes
- `docs/testing/` - Testing strategy and test cases
- `docs/deployment/` - Deployment and infrastructure docs
- `docs/monitoring/` - Monitoring and observability setup
...
- Review phase documentation in `docs/` before implementing features
...
- Copy the testing template (`docs/testing/README.md`) before creating feature-specific testing docs
...
- Follow the testing strategy defined in `docs/testing/`
...
- Record test coverage results and outstanding gaps in `docs/testing/`
